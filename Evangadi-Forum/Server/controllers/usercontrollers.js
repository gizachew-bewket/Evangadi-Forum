...
//       await sendEmail(
//         email,
//         "Your OTP Code it well expired in 5 min",
...
async function register(req, res) {
  ...
  console.log(
    ...
    "regex test:",
    passwordRegex.test(user_password)
  );
  ...
  try {
    ...
    console.log("Username check - existing users:", usernameValidation.length);
    console.log("Email check - existing users:", emailValidation.length);
